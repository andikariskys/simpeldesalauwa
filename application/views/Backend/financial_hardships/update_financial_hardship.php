            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-tanggal" name="tanggal"
                        value="<?= $data_financial_hardship->Tanggal_keterangantidakmampu ?>" readonly />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="input-no-kk" onchange="validateLength(this)"
                        name="no_kk" value="<?= $data_financial_hardship->No_kk ?>" placeholder="3313123456780004"
                        required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <img src="<?= base_url('assets/img-admin/sktm/' . $data_financial_hardship->kk) ?>"
                        alt="<?= $data_financial_hardship->kk ?>" class="rounded mb-3"
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="input-no-nik"  onchange="validateLength(this)" name="nik"
                        value="<?= $data_financial_hardship->Nik ?>" placeholder="3313123456780003" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-nama-lengkap" name="nama_lengkap"
                        value="<?= $data_financial_hardship->Nama ?>" placeholder="Magfira Islamia" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-ttl" name="ttl"
                        value="<?= $data_financial_hardship->Ttl ?>" placeholder="Jakarta, 2 Februari 2000" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input name="jenis_kelamin" class="form-check-input" type="radio" value="Laki-laki"
                            id="radio-laki-laki" <?php if ($data_financial_hardship->Jenis_kelamin == 'Laki-laki') {
                                echo "checked";
                            } ?> required>
                    ...
                    <div class="form-check">
                        <input name="jenis_kelamin" class="form-check-input" type="radio" value="Perempuan"
                            id="radio-perempuan" <?php if ($data_financial_hardship->Jenis_kelamin == 'Perempuan') {
                                echo "checked";
                            } ?>>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="input-alamat" name="alamat" placeholder="Jl. Merdeka No. 10"
                        required><?= $data_financial_hardship->Alamat ?></textarea>
                </div>
            </div>
