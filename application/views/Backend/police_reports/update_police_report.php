<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?= base_url('police_reports/' . $data_police_report->id_pengantarskck . '/update') ?>"
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-tanggal" name="tanggal"
                        value="<?= $data_police_report->Tanggal_pengantarskck ?>" readonly />
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="input-no-kk">Nomor KK</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-no-kk" onchange="validateLength(this)"
                        name="no_kk" value="<?= $data_police_report->No_kk ?>" placeholder="1234567890112233"
                        required />
                </div>
            </div>
            <div class="row mb-3">
...
<<<<<<< HEAD
                    <input type="text" class="form-control" id="input-nik" onchange="validateLength(this)" name="nik"
                        value="<?= $data_police_report->Nik ?>" placeholder="1234567890123456" required />
=======
                    <input type="text" class="form-control" id="input-no-nik" name="nik" value="<?= $data_police_report->Nik ?>" placeholder="1234567890123456" required />
>>>>>>> origin
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-nama" name="nama"
                        value="<?= $data_police_report->Nama ?>" placeholder="Magfira" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-ttl" name="ttl"
                        value="<?= $data_police_report->Ttl ?>" placeholder="Jakarta, 6 Juni 1985" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input name="jenis_kelamin" class="form-check-input" type="radio" value="Laki-laki"
                            id="radio-laki-laki" <?php if ($data_police_report->Jenis_kelamin == 'Laki-laki') {
                                echo "checked";
                            } ?> required>
                    ...
                    <div class="form-check">
                        <input name="jenis_kelamin" class="form-check-input" type="radio" value="Perempuan"
                            id="radio-perempuan" <?php if ($data_police_report->Jenis_kelamin == 'Perempuan') {
                                echo "checked";
                            } ?>>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-pekerjaan" name="pekerjaan"
                        value="<?= $data_police_report->Pekerjaan ?>" placeholder="Wiraswasta" required />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="input-alamat" name="alamat" placeholder="Jl. Merdeka No. 50"
                        required><?= $data_police_report->Alamat ?></textarea>
                </div>
            </div>
            <hr class="ml-0 mr-0 mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <img src="<?= base_url('assets/img-admin/spkck/' . $data_police_report->Ktp) ?>"
                        alt="<?= $data_police_report->Ktp ?>" class="rounded mb-3"
