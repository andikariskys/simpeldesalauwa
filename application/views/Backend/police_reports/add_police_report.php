            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-no-kk" onchange="validateLength(this)"
                        name="no_kk" placeholder="1234567890112233" required />
                </div>
            </div>
            <div class="row mb-3">
...
=======
                    <input type="text" class="form-control" id="input-no-nik" name="nik" placeholder="1234567890123456" required />
>>>>>>> origin
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-ttl" name="ttl" placeholder="Jakarta, 6 Juni 1985"
                        required />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-pekerjaan" name="pekerjaan"
                        placeholder="Wiraswasta" required />
                </div>
            </div>
            <div class="row mb-3">
