    ...
    <div class="card-body">
        <form action="<?= base_url('marriage_recommendations/add') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-no-nik" name="nik" placeholder="1122334455667788" required />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-ttl" name="ttl" placeholder="Jakarta, 5 Mei 1990" required />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-pekerjaan" name="pekerjaan" placeholder="Karyawan Swasta" required />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="input-alamat" name="alamat" placeholder="Jl. Merdeka No. 40" required></textarea>
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="input-anak-ke">Anak Ke-</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="input-anak-ke" name="anak_ke" placeholder="1" required />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-ttl-ayah" name="ttl_ayah" placeholder="Bandung, 1 Januari 1960" required />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-pekerjaan-ayah" name="pekerjaan_ayah" placeholder="Petani" required />
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="input-alamat-ayah">Alamat Ayah</label>
                <div class="col-sm-10">
                    <textarea class="form-control" id="input-alamat-ayah" name="alamat_ayah" placeholder="Jl. Desa No. 1" required></textarea>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-ttl-ibu" name="ttl_ibu" placeholder="Surabaya, 1 Januari 1965" required />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="input-alamat-ibu" name="alamat_ibu" placeholder="Jl. Desa No. 1" required></textarea>
                </div>
            </div>
            <hr class="ml-0 mr-0 mb-3">
