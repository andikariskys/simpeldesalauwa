...
<div class="card">
    <?php if ($this->session->flashdata('add_parent_income') != null) { ?>
        <div class="alert alert-success alert-dismissible my-3 mx-3" role="alert">
            <?= $this->session->flashdata('add_parent_income') ?>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    <?php } else if ($this->session->flashdata('delete_parent_income') != null) { ?>
        <div class="alert alert-danger alert-dismissible my-3 mx-3" role="alert">
            <?= $this->session->flashdata('delete_parent_income') ?>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
            ...
            <tbody>
                ...
                foreach ($parent_incomes as $parent_income) : ?>
                    <tr>
                        ...
                        <td><?= $parent_income->Status_penghasilanorangtua ?></td>                        
                        <td>
                            <div class="d-flex">
