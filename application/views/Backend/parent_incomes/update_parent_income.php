<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?= base_url('data_parent_incomes/' . $data_parent_income->id_penghasilan . '/update') ?>"
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-tanggal" name="tanggal" placeholder="2024-05-24"
                        value="<?= $data_parent_income->Tanggal_penghasilan ?>" readonly />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="input-no-kk" onchange="validateLength(this)"
                        name="no_kk" placeholder="3313123456780003" value="<?= $data_parent_income->No_kk ?>"
                        required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <img src="<?= base_url('assets/img-admin/spot/' . $data_parent_income->kk) ?>"
                        alt="<?= $data_parent_income->kk ?>" class="rounded mb-3"
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="input-no-nik"  onchange="validateLength(this)" name="nik"
                        placeholder="3313123456780004" value="<?= $data_parent_income->Nik ?>" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <img src="<?= base_url('assets/img-admin/spot/' . $data_parent_income->ktp) ?>"
                        alt="<?= $data_parent_income->ktp ?>" class="rounded mb-3"
                        style="max-width: 200px; height: auto;"> <br>
                    <span class="text-disabled">Note. Jika ingin mengubah foto silakan upload foto baru</span> <br>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-nama-lengkap" name="nama_lengkap"
                        placeholder="Magfira Islamia" value="<?= $data_parent_income->Nama ?>" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-ttl" name="ttl"
                        placeholder="Jakarta, 1 Januari 2000" value="<?= $data_parent_income->Ttl ?>" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        ...
                        <input name="jenis_kelamin" class="form-check-input" type="radio" value="Laki-laki"
                            id="radio-laki-laki" <?php if ($data_parent_income->Jenis_kelamin == 'Laki-laki') {
                                echo "checked";
                            } ?>>
                    </div>
                    <div class="form-check">
                        ...
                        <input name="jenis_kelamin" class="form-check-input" type="radio" value="Perempuan"
                            id="radio-perempuan" <?php if ($data_parent_income->Jenis_kelamin == 'Perempuan') {
                                echo "checked";
                            } ?>>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea name="alamat" id="input-alamat" class="form-control" placeholder="Jl. Mawar Merah No. 12"
                        required><?= $data_parent_income->Alamat ?></textarea>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-pekerjaan" name="pekerjaan"
                        placeholder="Pelajar/Mahasiswa" value="<?= $data_parent_income->Pekerjaan ?>" required />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="input-no-nik-ayah" name="nik_ayah"
                        placeholder="3313123456780001" value="<?= $data_parent_income->Nik_ayah ?>" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-nama-lengkap-ayah" name="nama_lengkap_ayah"
                        placeholder="Nama Lengkap Ayah" value="<?= $data_parent_income->Nama_ayah ?>" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-ttl-ayah" name="ttl_ayah"
                        placeholder="Jakarta, 1 Januari 1980" value="<?= $data_parent_income->Ttl_ayah ?>" required />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-pekerjaan-ayah" name="pekerjaan_ayah"
                        placeholder="Pegawai Swasta" value="<?= $data_parent_income->Pekerjaan_ayah ?>" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="input-penghasilan-ayah" name="penghasilan_ayah"
                        placeholder="2100000" value="<?= $data_parent_income->Penghasilan_ayah ?>" required />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="input-no-nik-ibu" name="nik_ibu"
                        placeholder="3313123456780002" value="<?= $data_parent_income->Nik_ibu ?>" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-nama-lengkap-ibu" name="nama_lengkap_ibu"
                        placeholder="Nama Lengkap Ibu" value="<?= $data_parent_income->Nama_ibu ?>" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-ttl-ibu" name="ttl_ibu"
                        placeholder="Jakarta, 1 Januari 1982" value="<?= $data_parent_income->Ttl_ibu ?>" required />
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-pekerjaan-ibu" name="pekerjaan_ibu"
                        placeholder="Ibu Rumah Tangga" value="<?= $data_parent_income->Pekerjaan_ibu ?>" required />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="input-penghasilan-ibu" name="penghasilan_ibu"
                        placeholder="0" value="<?= $data_parent_income->Penghasilan_ibu ?>" required />
                </div>
            </div>
