            ...
            <?php if (isset($_SESSION['is_login']) && $_SESSION['is_login'] == true) { ?>
                ...
                <div class="container">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('death-certificate/add') ?>" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control border-dark" id="input-nik"
                                            onchange="validateLength(this)" name="nik" placeholder="1234567890123456"
                                            required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control border-dark" id="input-pekerjaan"
                                            name="pekerjaan" placeholder="Pensiunan" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control border-dark" id="input-alamat" name="alamat"
                                            placeholder="Jl. Merdeka No. 30" required></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="input-hari-kematian">Hari Kematian</label>
                                    <div class="col-sm-10">
                                        <select name="hari_kematian" class="form-select  border-dark"
                                            aria-label="Default select example" id="input-hari-kematian" required>
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="input-tanggal-kematian">Tanggal
                                        Kematian</label>
                                    <div class="col-sm-10">
                                        <input type="date" id="input-tanggal-kematian" name="tanggal_kematian"
                                            placeholder="MM/DD/YYYY" class="form-control border-dark">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="input-hubungan-pelapor">Hubungan
                                        Pelapor</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="input-hubungan-pelapor" name="hubungan_pelapor"
                                            placeholder="Anak Kandung" class="form-control border-dark">
                                    </div>
                                </div>
