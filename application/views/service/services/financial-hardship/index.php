        ...
        <div class="row">
            <div class="container">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('financial-hardship/add') ?>" method="POST" enctype="multipart/form-data">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control border-dark" id="input-no-kk" name="no_kk" placeholder="3313123456780004" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control border-dark" id="input-no-nik" name="nik" placeholder="3313123456780003" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-dark" id="input-ttl" name="ttl" placeholder="Jakarta, 2 Februari 2000" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control border-dark" id="input-alamat" name="alamat" placeholder="Jl. Merdeka No. 10" required></textarea>
                                </div>
                            </div>
