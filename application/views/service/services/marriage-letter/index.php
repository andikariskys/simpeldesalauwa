        ...
        <div class="row">
            <div class="container">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('marriage-letter/add') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-dark" id="input-ttl" name="ttl" placeholder="Jakarta, 5 Mei 1990" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-dark" id="input-pekerjaan" name="pekerjaan" placeholder="Karyawan Swasta" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control border-dark" id="input-alamat" name="alamat" placeholder="Jl. Merdeka No. 40" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control border-dark" id="input-anak-ke" name="anak_ke" placeholder="1" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="input-nama-ayah">Nama Ayah</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-dark" id="input-nama-ayah" name="nama_ayah" placeholder="Nama Lengkap Ayah" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="input-ttl-ayah">Tempat, Tanggal Lahir Ayah</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-dark" id="input-ttl-ayah" name="ttl_ayah" placeholder="Bandung, 1 Januari 1960" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-dark" id="input-pekerjaan-ayah" name="pekerjaan_ayah" placeholder="Petani" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="input-alamat-ayah">Alamat Ayah</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control border-dark" id="input-alamat-ayah" name="alamat_ayah" placeholder="Jl. Desa No. 1" required></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="input-nama-ibu">Nama Ibu</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-dark" id="input-nama-ibu" name="nama_ibu" placeholder="Nama Lengkap Ibu" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="input-ttl-ibu">Tempat, Tanggal Lahir Ibu</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-dark" id="input-ttl-ibu" name="ttl_ibu" placeholder="Surabaya, 1 Januari 1965" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control border-dark" id="input-alamat-ibu" name="alamat_ibu" placeholder="Jl. Desa No. 1" required></textarea>
                                </div>
                            </div>
                            <hr class="ml-0 mr-0 mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="foto_kk" id="input-foto-kk" class="form-control border-dark" accept="image/jpg, image/jpeg, image/png, image/webp" required>
                                </div>
                            </div>
