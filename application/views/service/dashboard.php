...
<header id="header" class="header">
        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="text-container">
                    <h1 class="h1 text-left p-5 text-white">Selamat Datang di Sistem Informasi Pelayanan Kantor Desa Lauwa</h1>
                </div> <!-- end of text-container -->
            </div> <!-- end of col -->
            <div class="col-lg-3">
                <div class="text-container">
                    <a class="btn-outline-lg page-scroll" href="#contact"><i class="fas fa-user"></i>Logo</a>
                </div> <!-- end of text-container -->
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    ...
    <div class="container p-3">
        <div class="row">
            <div class="col-lg-12">
                <p class="footer-text text-white">© 2023 Sistem Informasi Pelayanan Kantor Desa Lauwa. All rights reserved.</p>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of container -->
    <!-- end of footer -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="text-container">
                        ...
                        <div class="icons-container">
                            <img src="<?php echo base_url() ?>assets/mark/images/details-icon-photoshop.png" alt="alternative">
                            <img src="<?php echo base_url() ?>assets/mark/images/details-icon-illustrator.png" alt="alternative">
                            <img src="<?php echo base_url() ?>assets/mark/images/details-icon-html.png" alt="alternative">
                            <img src="<?php echo base_url() ?>assets/mark/images/details-icon-css.png" alt="alternative">
                            <img src="<?php echo base_url() ?>assets/mark/images/details-icon-bootstrap.png" alt="alternative">
                            <img src="<?php echo base_url() ?>assets/mark/images/details-icon-javascript.png" alt="alternative">
            ...
            <div class="col-lg-12">
                <div class="text-container">
                    <div class="image-container">
                        <a href="project.html">
                            <img class="img-fluid" src="<?php echo base_url() ?>assets/mark/images/project-1.jpg" alt="alternative">
                        </a>
                ...
                <div class="text-container">
                    <div class="image-container">
                        <a href="project.html">
                            <img class="img-fluid" src="<?php echo base_url() ?>assets/mark/images/project-2.jpg" alt="alternative">
                        </a>
                    </div> <!-- end of image-container -->
                ...
                <div class="text-container">
                    <div class="image-container">
                        <a href="project.html">
                            <img class="img-fluid" src="<?php echo base_url() ?>assets/mark/images/project-3.jpg" alt="alternative">
                        </a>
                    </div> <!-- end of image-container -->
                ...
                <div class="text-container">
                    <div class="image-container">
                        <a href="project.html">
                            <img class="img-fluid" src="<?php echo base_url() ?>assets/mark/images/project-4.jpg" alt="alternative">
                        </a>
                    </div> <!-- end of image-container -->
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="details">
                            <img src="<?php echo base_url() ?>assets/mark/images/testimonial-1.jpg" alt="alternative">
                            <div class="text">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="details">
                            <img src="<?php echo base_url() ?>assets/mark/images/testimonial-2.jpg" alt="alternative">
                            <div class="text">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="details">
                            <img src="<?php echo base_url() ?>assets/mark/images/testimonial-3.jpg" alt="alternative">
                            <div class="text">
