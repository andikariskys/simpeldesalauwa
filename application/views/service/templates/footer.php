...
<div class="container  p-3">
    <div class="row">
        <div class="col-lg-12">
            <p class="footer-text text-dark fw-bold">Copyright © 2024 Design By Desa Lauwa.</p>
        </div> <!-- end of col -->
    </div> <!-- end of row -->
...
<script src="<?php echo base_url() ?>assets/mark/jquery/jquery.min.js"></script>
...
<script src="<?php echo base_url() ?>assets/mark/datatables/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url() ?>assets/mark/datatables/jquery.dataTables.min.js"></script>
